...
Contributors: Evolurise - Walid SADFI
Tags: maintenance mode, user roles, custom message
...
3. Go to the 'Maintenance Mode' settings page in the WordPress admin area to configure the plugin.
4. Configure the plugin options and save the changes.
...
2. Maintenance message displayed to users without the necessary roles
